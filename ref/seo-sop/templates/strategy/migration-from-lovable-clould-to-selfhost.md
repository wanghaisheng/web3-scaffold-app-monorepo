...
> Export your code and data, run database migrations, and migrate your Lovable Cloud project to Supabase or another provider.

[Lovable Cloud](https://docs.lovable.dev/features/cloud) is designed to be the easiest, fastest, and most enjoyable place to build. Migration is possible because we want you to stay by choice, not necessity.

This guide explains how you can self-host and move your Lovable Cloud project to another provider, for example [Supabase](http://supabase.com/).
...
* **We earn your trust through quality, not control**.
  ...
  Lovable Cloud is designed for speed, simplicity, and reliability. You can build, host, and scale confidently, knowing you can take your project with you.
...
<Warning>
  After migrating your project to your own Supabase instance, you must continue development in your local environment or a preferred IDE. Your project in Lovable remains connected to the original Lovable Cloud database, so any changes made in Lovable after migration will **not** sync with your new Supabase setup.
</Warning>
