...
- [ ] Test framework detected (Playwright, Vitest, Cypress, etc.)
- [ ] Test framework configuration found (playwright.config.ts, vitest.config.ts, etc.)
...
- [ ] Review adapts to test framework (Playwright vs Vitest vs Cypress)
...
- **Test Framework**: [Playwright, Vitest, Cypress, etc.]
