...
description: 'Critical validation workflow that assesses PRD, Architecture, and Epics & Stories for completeness and alignment before implementation for BMM mode. Uses adversarial review approach to find gaps and issues.'
web_bundle: false
openspec_integration: "mandatory"
openspec_role: "readiness_validator"
workflow_type: "bmm"
---
