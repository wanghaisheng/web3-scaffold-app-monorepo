...
- **Web application** ‚Ü?Look for Next.js, Vite, Remix, SvelteKit starters
- **Mobile app** ‚Ü?Look for React Native, Expo, Flutter starters
- **API/Backend** ‚Ü?Look for NestJS, Express, Fastify, hosted-backend starters
- **CLI tool** ‚Ü?Look for CLI framework starters (oclif, commander, etc.)
- **Full-stack** ‚Ü?Look for T3, RedwoodJS, Blitz, Next.js starters
- **Desktop** ‚Ü?Look for Electron, Tauri starters

### 2. UX Requirements Consideration

If UX specification was loaded, consider UX requirements when selecting starter:

- **Rich animations** ‚Ü?Framer Motion compatible starter
- **Complex forms** ‚Ü?React Hook Form included starter
- **Real-time features** ‚Ü?Socket.io or WebSocket ready starter
- **Design system** ‚Ü?Storybook-enabled starter
- **Offline capability** ‚Ü?Service worker or PWA configured starter
...
‚ú?Primary technology domain correctly identified from project context
‚ú?Current, maintained starter templates researched and evaluated
‚ú?All versions verified using web search, not hardcoded
‚ú?Architectural implications of starter choice clearly documented
‚ú?User provided with clear rationale for starter selection
‚ú?A/P/C menu presented and handled correctly
‚ú?Content properly appended to document when C selected

## FAILURE MODES:

‚ù?Not verifying current versions with web search
‚ù?Ignoring UX requirements when evaluating starters
‚ù?Not documenting what architectural decisions the starter makes
‚ù?Failing to consider maintenance status of starter templates
‚ù?Not providing clear rationale for starter selection
‚ù?Not presenting A/P/C menu after content generation
