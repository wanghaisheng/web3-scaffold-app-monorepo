...
This project includes integration with [react-native-godot](https://github.com/borndotcom/react-native-godot), allowing you to embed Godot games into your React Native Expo application.

### Setup

- Godot integration is pre-configured with `react-native-godot@1.0.1`
- A game screen is available at `/game` route
- Place your Godot game files in `assets/godot/` directory

### Documentation

For detailed instructions on Godot integration, see [GODOT_INTEGRATION.md](./GODOT_INTEGRATION.md).
